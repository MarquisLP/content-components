...
function VTTCueShim(startTime, endTime, text) {
	var cue = this;
	...
	// Lets us know when the VTTCueShim's data has changed in such a way that we need
...
VTTCueShim.prototype.getCueAsHTML = function() {
...
WebVTT.Parser = function() {
	this.state = "INITIAL";
	this.buffer = "";
	this.decoder = WebVTT.StringDecoder();
	this.regionList = [];
};
...
WebVTT.Parser.prototype = {
	...
	function parseRegion(input) {
		...
		// Remember the VTTRegionShim for later in case we parse any VTTCueShims that
		// reference it.
